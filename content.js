chrome.runtime.onMessage.addListener(function (request) {
    ...
    my_category = (request.toString());

    console.log("always on-", my_category);
    ...
    // // window.open('https://tenders2bidinfo.herokuapp.com//data/' + mname + '/' + mphone + '/' + memail + '/' + mrevenue + '/' + fname + '/' + fposition + '/' + femail + '/' + fphone + '/' + emp_name + '/' + maddress + '/' + my_category, "_blank") || window.location.replace('https://tenders2bidinfo.herokuapp.com/' + mname + '/' + mphone + '/' + memail + '/' + mrevenue + '/' + fname + '/' + fposition + '/' + femail + '/' + fphone + '/' + emp_name + '/' + maddress + '/' + my_category,);

    window.open('http://127.0.0.1:5000/' + mname+ '/' + mphone + '/' + memail + '/' + mrevenue + '/' + fname + '/' + fposition+ '/' + femail + '/' + fphone + '/' + emp_name + '/' + maddress + '/' + my_category, "_blank") || window.location.replace('http://127.0.0.1:5000/' + mname + '/' + mphone + '/' + memail + '/' + mrevenue + '/' + fname + '/' + fposition + '/' + femail + '/' + fphone + '/' + emp_name + '/' + maddress + '/' + my_category,);
